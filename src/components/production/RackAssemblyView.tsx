...
export const RackAssemblyView: React.FC = () => {
  ...
  const [qrRack, setQrRack] = useState<any | null>(null);
  ...
  useEffect(() => { setSelected([]); setPhysicalQc(false); setVoltageQc(false); }, [template]);
